...
public class GenGrid<TGridObject>
{
    ...
    public GenGrid(int width, int height, float cellSize, Vector3 originPosition, Func<GenGrid<TGridObject>, int, int, TGridObject> createGridObject)
    {
        this.width = width;
        this.height = height;
